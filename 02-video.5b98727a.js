...
var t =
  "undefined" != typeof globalThis
    ...
    ? global
    : {};
/*! @vimeo/player v2.18.0 | (c) 2022 Vimeo | MIT License | https://github.com/vimeo/player.js */ function n(
  e,
  t
) {
  if (!(e instanceof t))
...
function P(e, t) {
  ...
  if ((t = E(t)).event) {
    ...
    (r = w(e, "event:".concat(t.event))), (n = t.data);
  } else if (t.method) {
    var o = (function (e, t) {
      var n = w(e, t);
  ...
  S = (function () {
    function e(t) {
      ...
      (this._window = t.ownerDocument.defaultView),
        (this.element = t),
        (this.origin = "*");
      var u = new p(function (e, n) {
        if (
          ((r._onMessage = function (t) {
            if (c(t.origin) && r.element.contentWindow === t.source) {
              ...
              var a = o && "ready" === o.event,
                u = o && "ping" === o.method;
              if (a || u)
                return r.element.setAttribute("data-ready", "true"), void e();
              P(r, o);
            }
          }),
      ...
      if (
        ...
        (this.fullscreenchangeHandler = function () {
          C.isFullscreen
            ? y(r, "event:exitFullscreen", l)
            : b(r, "event:exitFullscreen", l),
            r.ready().then(function () {
              T(r, "fullscreenchange", C.isFullscreen);
            });
        }),
          C.on("fullscreenchange", this.fullscreenchangeHandler);
      }
      return this;
    }
    var t, o, u;
          ...
          value: function (e) {
            ...
            return new p(function (r, o) {
              return t
                .ready()
                .then(function () {
                  y(t, e, { resolve: r, reject: o }), T(t, e, n);
                })
                .catch(o);
            });
          },
            ...
            return new p(function (n, r) {
              return (
                ...
                t
                  .ready()
                  .then(function () {
                    y(t, e, { resolve: n, reject: r }), T(t, e);
                  })
                  .catch(r)
              );
            });
          ...
          value: function (e, t) {
            ...
            return new p(function (r, o) {
              ...
              return n
                .ready()
                .then(function () {
                  y(n, e, { resolve: r, reject: o }), T(n, e, t);
                })
                .catch(o);
            });
          },
          ...
          value: function () {
            ...
            return new p(function (t) {
              ...
              e._window.removeEventListener("message", e._onMessage),
                C.isEnabled &&
                  C.off("fullscreenchange", e.fullscreenchangeHandler),
                t();
            });
          },
        },
...
function J(e) {
  ...
  e = e.replace(q, "");
  var n = V.test(e);
  return n || R.test(e) ? W(e.slice(2), n ? 2 : 8) : I.test(e) ? NaN : +e;
}
A = function (e, t, n) {
  var r = !0,
    o = !0;
  ...
  return (
    ...
    Q(e, t, { leading: r, maxWait: t, trailing: o })
  );
};
const X = new O(document.querySelector("iframe"));
X.setCurrentTime(localStorage.getItem("videoplayer-current-time") || 0);
X.on(
  "timeupdate",
  e(A)((e) => localStorage.setItem("videoplayer-current-time", e.seconds), 1e3)
);
//# sourceMappingURL=02-video.5b98727a.js.map
