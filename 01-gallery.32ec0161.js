              ...
              for (i.s(); !(o = i.n()).done; ) {
                ...
                try {
                  for (r.s(); !(a = r.n()).done; ) {
                    ...
                    s.namespaces &&
                      s.namespaces[l] &&
                      (s.removeEventListener(l.split(".")[0], s.namespaces[l]),
        ...
        },
        {
          ...
          value: function (t, e, o, i) {
            ...
            try {
              for (r.s(); !(a = r.n()).done; ) {
                var l = a.value;
                l && ((l.style.opacity = 0), (l.style.display = i || "block"));
              }
            } catch (t) {
              r.e(t);
            } finally {
            ...
            try {
              for (i.s(); !(o = i.n()).done; ) {
                ...
                try {
                  for (r.s(); !(s = r.n()).done; ) {
                    var l = s.value;
                    (a.fullyNamespacedEvents[l] = e), a.addEventListener(l, e);
                  }
                } catch (t) {
                  r.e(t);
                } finally {
...
const m = document.querySelector(".gallery"),
  f = p
    .map((t) =>
      (({ preview: t, original: e, description: o }) =>
...
//# sourceMappingURL=01-gallery.32ec0161.js.map
