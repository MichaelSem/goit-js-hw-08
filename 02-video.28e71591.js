!(function () {
  ...
  var t =
      "undefined" != typeof globalThis
        ...
        : {},
    n = {};
  /*! @vimeo/player v2.18.0 | (c) 2022 Vimeo | MIT License | https://github.com/vimeo/player.js */ function r(
    e,
    t
  ) {
    if (!(e instanceof t))
    ...
    if (!t.WeakMap) {
      ...
      t.WeakMap = (function () {
        function t() {
          ...
          if ((i(this, "_id", u("_WeakMap")), arguments.length > 0))
        ...
        return (
          i(t.prototype, "delete", function (e) {
            if ((o(this, "delete"), !a(e))) return !1;
            var t = e[this._id];
            return !(!t || t[0] !== e) && (delete e[this._id], !0);
          }),
          i(t.prototype, "get", function (e) {
            if ((o(this, "get"), a(e))) {
              var t = e[this._id];
              return t && t[0] === e ? t[1] : void 0;
            }
          }),
          i(t.prototype, "has", function (e) {
            if ((o(this, "has"), !a(e))) return !1;
            var t = e[this._id];
            return !(!t || t[0] !== e);
          }),
          i(t.prototype, "set", function (e, t) {
            if ((o(this, "set"), !a(e)))
...
*/
        ...
        (i = function () {
          ...
          function u(e, t) {
            o.add(e, t), r || (r = a(o.drain));
          }
          function c(t) {
            var r,
              o = void 0 === t ? "undefined" : e(n)(t);
            return (
              null == t || ("object" != o && "function" != o) || (r = t.then),
              "function" == typeof r && r
            );
          }
          function l() {
            ...
            if (!n.triggered) {
              ...
              try {
                (t = c(e))
                  ...
                  : ((n.msg = e), (n.state = 1), n.chain.length > 0 && u(l, n));
              } catch (e) {
                d.call(new v(n), e);
              }
            }
          ...
          o = (function () {
            ...
            return {
              ...
              drain: function () {
                var n = e;
                for (e = t = r = void 0; n; ) n.fn.call(n.self), (n = n.next);
              },
            };
          })();
          var g = t({}, "constructor", p, !1);
          return (
            (p.prototype = g),
            t(g, "__NPO__", 0, !1),
            t(p, "resolve", function (e) {
          ...
          ((o = v)[(r = "Promise")] = o[r] || i()),
          t.exports && (t.exports = o[r]);
      }),
      m((p = { exports: {} }), p.exports),
      p.exports),
    y = new WeakMap();
  function w(e, t, n) {
            ...
            ((n._onMessage = function (t) {
              if (l(t.origin) && n.element.contentWindow === t.source) {
                ...
                var a = o && "ready" === o.event,
                  u = o && "ping" === o.method;
                if (a || u)
                  return n.element.setAttribute("data-ready", "true"), void e();
                _(n, o);
              }
            }),
          ...
          (this.fullscreenchangeHandler = function () {
            S.isFullscreen
              ...
              n.ready().then(function () {
                P(n, "fullscreenchange", S.isFullscreen);
              });
          }),
            ...
            value: function (e) {
              ...
              return new g(function (r, o) {
                return t
                  .ready()
                  .then(function () {
                    w(t, e, { resolve: r, reject: o }), P(t, e, n);
                  })
                  .catch(o);
              });
            },
              ...
              return new g(function (n, r) {
                return (
                  ...
                  t
                    .ready()
                    .then(function () {
                      w(t, e, { resolve: n, reject: r }), P(t, e);
                    })
                    .catch(r)
                );
              });
            ...
            value: function (e, t) {
              ...
              return new g(function (r, o) {
                ...
                return n
                  .ready()
                  .then(function () {
                    w(n, e, { resolve: r, reject: o }), P(n, e, t);
                  })
                  .catch(o);
              });
            },
        ...
        var t = function (e) {
          ...
          n = function (n) {
            ...
            if (l(n.origin)) {
              ...
              if (o && "ready" === o.event)
                for (
                  var i = e.querySelectorAll("iframe"), a = 0;
                  a < i.length;
                  a++
                )
                  r(a);
  ...
  function J(e, t, n) {
    ...
    function v(e) {
      return (l = e), (u = setTimeout(p, t)), s ? h(e) : a;
    }
    function m(e) {
      var n = e - c;
    ...
    function y() {
      ...
      if (((r = arguments), (o = this), (c = e), n)) {
        ...
        if (f) return (u = setTimeout(p, t)), h(c);
      }
      return void 0 === u && (u = setTimeout(p, t)), a;
    }
    return (
      (t = G(t) || 0),
      X(n) &&
        ((s = !!n.leading),
        (i = (f = "maxWait" in n) ? B(G(n.maxWait) || 0, t) : i),
        (d = "trailing" in n ? !!n.trailing : d)),
      (y.cancel = function () {
        void 0 !== u && clearTimeout(u), (l = 0), (r = c = o = u = void 0);
      }),
      (y.flush = function () {
        return void 0 === u ? a : g(Y());
      }),
      y
    );
  }
  ...
  function G(t) {
    ...
    if (
      (function (t) {
        return (
          "symbol" == (void 0 === t ? "undefined" : e(n)(t)) ||
          ((function (e) {
    ...
    t = t.replace(V, "");
    var o = W.test(t);
    return o || L.test(t) ? z(t.slice(2), o ? 2 : 8) : R.test(t) ? NaN : +t;
  }
  O = function (e, t, n) {
    var r = !0,
      o = !0;
    ...
    return (
      ...
      J(e, t, { leading: r, maxWait: t, trailing: o })
    );
  };
  var K = new q(document.querySelector("iframe")),
    Z = "videoplayer-current-time";
  K.setCurrentTime(localStorage.getItem(Z) || 0);
  K.on(
    "timeupdate",
    e(O)(function (e) {
      return localStorage.setItem(Z, e.seconds);
    }, 1e3)
  );
})();
//# sourceMappingURL=02-video.28e71591.js.map
